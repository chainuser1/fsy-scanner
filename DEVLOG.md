...
1. Removed five deprecated lint rules from analysis_options.yaml that were causing GitHub Actions CI failure
2. Optimized the active sync interval from 5 seconds to 2 seconds for better UX

### Changes:

**Removed deprecated lint rules** from [fsy_scanner/analysis_options.yaml](fsy_scanner/analysis_options.yaml):
...
**Optimized active sync interval** in [lib/sync/sync_engine.dart](lib/sync/sync_engine.dart):
...
### Files Modified:
- [fsy_scanner/analysis_options.yaml](fsy_scanner/analysis_options.yaml) – removed deprecated lint rules
- [lib/sync/sync_engine.dart](lib/sync/sync_engine.dart) – changed sync interval: 5s → 2s
...
### Corrections Made
Removed all five deprecated rules from analysis_options.yaml. Reduced sync interval for better responsiveness.
...
### What I Did
Enhanced the accessibility of the settings screen by adding a semantic label to the Save button in [lib/screens/settings_screen.dart](file:///home/lotus_clan/Documents/Projects/fsy_reg_app/fsy_scanner/lib/screens/settings_screen.dart).
